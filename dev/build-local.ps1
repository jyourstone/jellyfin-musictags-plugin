...
# This script builds the MusicTags plugin and prepares it for local Docker-based testing.
...
Write-Host "Building MusicTags plugin version for local development..."
...
# Build the project
dotnet build ..\Jellyfin.Plugin.MusicTags\Jellyfin.Plugin.MusicTags.csproj --configuration Release -o $OUTPUT_DIR /p:Version=$VERSION /p:AssemblyVersion=$VERSION
